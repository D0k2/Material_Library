...
2.1. Подбор по температуре:
   - Отфильтруйте материалы по "Области применения".
...
2.2. Сравнение материалов (свойства):
   ...
   - Доступны инструменты работы с графиком:
        ...
        - Кнопка "Настройки" позволит настроить отображение графика
...
3.1. Редактирование материала:
   - Выберите материал из выпадающего списка вверху вкладки (перещелкните материалы для подгрузки "Области применения").
   - Внесите изменения на любой из подвкладок ("Общие данные", "Физические свойства" и т.д.).
   - В таблицах для редактирования ячейки используйте двойной клик. В таблицах свойств рядом с данными отображается интерактивный график.
...
- Поправлено визуальное оформление вывода хим. состава в области "Сравнение материалов (хим. состав)"
